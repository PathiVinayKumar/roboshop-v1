...
mysql -h 10.1.0.6 -u root -pRoboShop@1 < db/schema.sql
mysql -h 10.1.0.6 -u root -pRoboShop@1 < db/app-user.sql
mysql -h 10.1.0.6 -u root -pRoboShop@1 catalogue < db/master-data.sql
